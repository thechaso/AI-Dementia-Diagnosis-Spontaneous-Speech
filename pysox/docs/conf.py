...
pysox_version = SourceFileLoader("sox.version", "../sox/version.py").load_module()
...
latex_documents = [
    (master_doc, "pysox.tex", "pysox Documentation", "Rachel Bittner", "manual"),
]
...
man_pages = [(master_doc, "pysox", "pysox Documentation", [author], 1)]
